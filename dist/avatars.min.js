(function(N,G){typeof exports=="object"&&typeof module!="undefined"?module.exports=G(require("three")):typeof define=="function"&&define.amd?define(["three"],G):(N=typeof globalThis!="undefined"?globalThis:N||self,N.Avatars=G(N.THREE))})(this,function(N){"use strict";function G(r){if(r&&r.__esModule)return r;var e=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});return r&&Object.keys(r).forEach(function(n){if(n!=="default"){var i=Object.getOwnPropertyDescriptor(r,n);Object.defineProperty(e,n,i.get?i:{enumerable:!0,get:function(){return r[n]}})}}),e.default=r,Object.freeze(e)}var t=G(N);/*! (c) 2019-2021 pixiv Inc. - https://github.com/pixiv/three-vrm/blob/release/LICENSE *//*! *****************************************************************************
  ...
  ***************************************************************************** */function O(r,e,n,i){return new(n||(n=Promise))(function(a,s){function o(d){try{c(i.next(d))}catch(u){s(u)}}function l(d){try{c(i.throw(d))}catch(u){s(u)}}function c(d){var u;d.done?a(d.value):(u=d.value,u instanceof n?u:new n(function(f){f(u)})).then(o,l)}c((i=i.apply(r,e||[])).next())})}var f0;(function(r){r[r.NUMBER=0]="NUMBER",r[r.VECTOR2=1]="VECTOR2",r[r.VECTOR3=2]="VECTOR3",r[r.VECTOR4=3]="VECTOR4",r[r.COLOR=4]="COLOR"})(f0||(f0={})),new t.Vector2,new t.Vector3,new t.Vector4,new t.Color;var w0;(function(r){var e,n,i,a,s,o;(e=r.BlendShapePresetName||(r.BlendShapePresetName={})).A="a",e.Angry="angry",e.Blink="blink",e.BlinkL="blink_l",e.BlinkR="blink_r",e.E="e",e.Fun="fun",e.I="i",e.Joy="joy",e.Lookdown="lookdown",e.Lookleft="lookleft",e.Lookright="lookright",e.Lookup="lookup",e.Neutral="neutral",e.O="o",e.Sorrow="sorrow",e.U="u",e.Unknown="unknown",(n=r.FirstPersonLookAtTypeName||(r.FirstPersonLookAtTypeName={})).BlendShape="BlendShape",n.Bone="Bone",(i=r.HumanoidBoneName||(r.HumanoidBoneName={})).Chest="chest",i.Head="head",i.Hips="hips",i.Jaw="jaw",i.LeftEye="leftEye",i.LeftFoot="leftFoot",i.LeftHand="leftHand",i.LeftIndexDistal="leftIndexDistal",i.LeftIndexIntermediate="leftIndexIntermediate",i.LeftIndexProximal="leftIndexProximal",i.LeftLittleDistal="leftLittleDistal",i.LeftLittleIntermediate="leftLittleIntermediate",i.LeftLittleProximal="leftLittleProximal",i.LeftLowerArm="leftLowerArm",i.LeftLowerLeg="leftLowerLeg",i.LeftMiddleDistal="leftMiddleDistal",i.LeftMiddleIntermediate="leftMiddleIntermediate",i.LeftMiddleProximal="leftMiddleProximal",i.LeftRingDistal="leftRingDistal",i.LeftRingIntermediate="leftRingIntermediate",i.LeftRingProximal="leftRingProximal",i.LeftShoulder="leftShoulder",i.LeftThumbDistal="leftThumbDistal",i.LeftThumbIntermediate="leftThumbIntermediate",i.LeftThumbProximal="leftThumbProximal",i.LeftToes="leftToes",i.LeftUpperArm="leftUpperArm",i.LeftUpperLeg="leftUpperLeg",i.Neck="neck",i.RightEye="rightEye",i.RightFoot="rightFoot",i.RightHand="rightHand",i.RightIndexDistal="rightIndexDistal",i.RightIndexIntermediate="rightIndexIntermediate",i.RightIndexProximal="rightIndexProximal",i.RightLittleDistal="rightLittleDistal",i.RightLittleIntermediate="rightLittleIntermediate",i.RightLittleProximal="rightLittleProximal",i.RightLowerArm="rightLowerArm",i.RightLowerLeg="rightLowerLeg",i.RightMiddleDistal="rightMiddleDistal",i.RightMiddleIntermediate="rightMiddleIntermediate",i.RightMiddleProximal="rightMiddleProximal",i.RightRingDistal="rightRingDistal",i.RightRingIntermediate="rightRingIntermediate",i.RightRingProximal="rightRingProximal",i.RightShoulder="rightShoulder",i.RightThumbDistal="rightThumbDistal",i.RightThumbIntermediate="rightThumbIntermediate",i.RightThumbProximal="rightThumbProximal",i.RightToes="rightToes",i.RightUpperArm="rightUpperArm",i.RightUpperLeg="rightUpperLeg",i.Spine="spine",i.UpperChest="upperChest",(a=r.MetaAllowedUserName||(r.MetaAllowedUserName={})).Everyone="Everyone",a.ExplicitlyLicensedPerson="ExplicitlyLicensedPerson",a.OnlyAuthor="OnlyAuthor",(s=r.MetaUssageName||(r.MetaUssageName={})).Allow="Allow",s.Disallow="Disallow",(o=r.MetaLicenseName||(r.MetaLicenseName={})).Cc0="CC0",o.CcBy="CC_BY",o.CcByNc="CC_BY_NC",o.CcByNcNd="CC_BY_NC_ND",o.CcByNcSa="CC_BY_NC_SA",o.CcByNd="CC_BY_ND",o.CcBySa="CC_BY_SA",o.Other="Other",o.RedistributionProhibited="Redistribution_Prohibited"})(w0||(w0={}));const ye=new t.Vector3,_e=new t.Vector3;function a0(r,e){return r.matrixWorld.decompose(ye,e,_e),e}new t.Quaternion,Object.freeze(new t.Vector3(0,0,-1)),new t.Quaternion;var y0;(function(r){r[r.Auto=0]="Auto",r[r.Both=1]="Both",r[r.ThirdPersonOnly=2]="ThirdPersonOnly",r[r.FirstPersonOnly=3]="FirstPersonOnly"})(y0||(y0={}));function Le(r){return r.invert?r.invert():r.inverse(),r}new t.Vector3,new t.Quaternion;const Me=Object.freeze(new t.Vector3(0,0,-1)),xe=new t.Vector3,Ae=new t.Vector3,Pe=new t.Vector3,_0=new t.Quaternion;class K{constructor(e,n){this.autoUpdate=!0,this._euler=new t.Euler(0,0,0,K.EULER_ORDER),this.firstPerson=e,this.applyer=n}getLookAtWorldDirection(e){const n=a0(this.firstPerson.firstPersonBone,_0);return e.copy(Me).applyEuler(this._euler).applyQuaternion(n)}lookAt(e){this._calcEuler(this._euler,e),this.applyer&&this.applyer.lookAt(this._euler)}update(e){this.target&&this.autoUpdate&&(this.lookAt(this.target.getWorldPosition(xe)),this.applyer&&this.applyer.lookAt(this._euler))}_calcEuler(e,n){const i=this.firstPerson.getFirstPersonWorldPosition(Ae),a=Pe.copy(n).sub(i).normalize();return a.applyQuaternion(Le(a0(this.firstPerson.firstPersonBone,_0))),e.x=Math.atan2(a.y,Math.sqrt(a.x*a.x+a.z*a.z)),e.y=Math.atan2(-a.x,-a.z),e}}K.EULER_ORDER="YXZ",new t.Euler(0,0,0,K.EULER_ORDER);var L0,M0,x0,A0,P0;(function(r){r[r.Off=0]="Off",r[r.Front=1]="Front",r[r.Back=2]="Back"})(L0||(L0={})),function(r){r[r.None=0]="None",r[r.Normal=1]="Normal",r[r.LitShadeRate=2]="LitShadeRate",r[r.UV=3]="UV"}(M0||(M0={})),function(r){r[r.FixedColor=0]="FixedColor",r[r.MixedLighting=1]="MixedLighting"}(x0||(x0={})),function(r){r[r.None=0]="None",r[r.WorldCoordinates=1]="WorldCoordinates",r[r.ScreenCoordinates=2]="ScreenCoordinates"}(A0||(A0={})),function(r){r[r.Opaque=0]="Opaque",r[r.Cutout=1]="Cutout",r[r.Transparent=2]="Transparent",r[r.TransparentWithZWrite=3]="TransparentWithZWrite"}(P0||(P0={}));var v0;(function(r){r[r.Opaque=0]="Opaque",r[r.Cutout=1]="Cutout",r[r.Transparent=2]="Transparent",r[r.TransparentWithZWrite=3]="TransparentWithZWrite"})(v0||(v0={}));const ve=new t.Matrix4;function R0(r){return r.invert?r.invert():r.getInverse(ve.copy(r)),r}class Re{constructor(e){this._inverseCache=new t.Matrix4,this._shouldUpdateInverse=!0,this.matrix=e;const n={set:(i,a,s)=>(this._shouldUpdateInverse=!0,i[a]=s,!0)};this._originalElements=e.elements,e.elements=new Proxy(e.elements,n)}get inverse(){return this._shouldUpdateInverse&&(R0(this._inverseCache.copy(this.matrix)),this._shouldUpdateInverse=!1),this._inverseCache}revert(){this.matrix.elements=this._originalElements}}const Te=Object.freeze(new t.Matrix4),Fe=Object.freeze(new t.Quaternion),U=new t.Vector3,T0=new t.Vector3,be=new t.Vector3,Ve=new t.Quaternion,L=new t.Matrix4,e0=new t.Matrix4;class We{constructor(e,n={}){var i,a,s,o,l,c;if(this._currentTail=new t.Vector3,this._prevTail=new t.Vector3,this._nextTail=new t.Vector3,this._boneAxis=new t.Vector3,this._centerSpacePosition=new t.Vector3,this._center=null,this._parentWorldRotation=new t.Quaternion,this._initialLocalMatrix=new t.Matrix4,this._initialLocalRotation=new t.Quaternion,this._initialLocalChildPosition=new t.Vector3,this.bone=e,this.bone.matrixAutoUpdate=!1,this.radius=(i=n.radius)!==null&&i!==void 0?i:.02,this.stiffnessForce=(a=n.stiffnessForce)!==null&&a!==void 0?a:1,this.gravityDir=n.gravityDir?new t.Vector3().copy(n.gravityDir):new t.Vector3().set(0,-1,0),this.gravityPower=(s=n.gravityPower)!==null&&s!==void 0?s:0,this.dragForce=(o=n.dragForce)!==null&&o!==void 0?o:.4,this.colliders=(l=n.colliders)!==null&&l!==void 0?l:[],this._centerSpacePosition.setFromMatrixPosition(this.bone.matrixWorld),this._initialLocalMatrix.copy(this.bone.matrix),this._initialLocalRotation.copy(this.bone.quaternion),this.bone.children.length===0)this._initialLocalChildPosition.copy(this.bone.position).normalize().multiplyScalar(.07);else{const d=this.bone.children[0];this._initialLocalChildPosition.copy(d.position)}this.bone.localToWorld(this._currentTail.copy(this._initialLocalChildPosition)),this._prevTail.copy(this._currentTail),this._nextTail.copy(this._currentTail),this._boneAxis.copy(this._initialLocalChildPosition).normalize(),this._centerSpaceBoneLength=U.copy(this._initialLocalChildPosition).applyMatrix4(this.bone.matrixWorld).sub(this._centerSpacePosition).length(),this.center=(c=n.center)!==null&&c!==void 0?c:null}get center(){return this._center}set center(e){var n;this._getMatrixCenterToWorld(L),this._currentTail.applyMatrix4(L),this._prevTail.applyMatrix4(L),this._nextTail.applyMatrix4(L),!((n=this._center)===null||n===void 0)&&n.userData.inverseCacheProxy&&(this._center.userData.inverseCacheProxy.revert(),delete this._center.userData.inverseCacheProxy),this._center=e,this._center&&(this._center.userData.inverseCacheProxy||(this._center.userData.inverseCacheProxy=new Re(this._center.matrixWorld))),this._getMatrixWorldToCenter(L),this._currentTail.applyMatrix4(L),this._prevTail.applyMatrix4(L),this._nextTail.applyMatrix4(L),L.multiply(this.bone.matrixWorld),this._centerSpacePosition.setFromMatrixPosition(L),this._centerSpaceBoneLength=U.copy(this._initialLocalChildPosition).applyMatrix4(L).sub(this._centerSpacePosition).length()}reset(){this.bone.quaternion.copy(this._initialLocalRotation),this.bone.updateMatrix(),this.bone.matrixWorld.multiplyMatrices(this._getParentMatrixWorld(),this.bone.matrix),this._centerSpacePosition.setFromMatrixPosition(this.bone.matrixWorld),this.bone.localToWorld(this._currentTail.copy(this._initialLocalChildPosition)),this._prevTail.copy(this._currentTail),this._nextTail.copy(this._currentTail)}update(e){if(e<=0)return;this.bone.parent?a0(this.bone.parent,this._parentWorldRotation):this._parentWorldRotation.copy(Fe),this._getMatrixWorldToCenter(L),L.multiply(this.bone.matrixWorld),this._centerSpacePosition.setFromMatrixPosition(L),this._getMatrixWorldToCenter(e0),e0.multiply(this._getParentMatrixWorld());const n=this.stiffnessForce*e,i=T0.copy(this.gravityDir).multiplyScalar(this.gravityPower*e);this._nextTail.copy(this._currentTail).add(U.copy(this._currentTail).sub(this._prevTail).multiplyScalar(1-this.dragForce)).add(U.copy(this._boneAxis).applyMatrix4(this._initialLocalMatrix).applyMatrix4(e0).sub(this._centerSpacePosition).normalize().multiplyScalar(n)).add(i),this._nextTail.sub(this._centerSpacePosition).normalize().multiplyScalar(this._centerSpaceBoneLength).add(this._centerSpacePosition),this._collision(this._nextTail),this._prevTail.copy(this._currentTail),this._currentTail.copy(this._nextTail);const a=R0(L.copy(e0.multiply(this._initialLocalMatrix))),s=Ve.setFromUnitVectors(this._boneAxis,U.copy(this._nextTail).applyMatrix4(a).normalize());this.bone.quaternion.copy(this._initialLocalRotation).multiply(s),this.bone.updateMatrix(),this.bone.matrixWorld.multiplyMatrices(this._getParentMatrixWorld(),this.bone.matrix)}_collision(e){this.colliders.forEach(n=>{this._getMatrixWorldToCenter(L),L.multiply(n.matrixWorld);const i=U.setFromMatrixPosition(L),a=n.geometry.boundingSphere.radius,s=this.radius+a;if(e.distanceToSquared(i)<=s*s){const o=T0.subVectors(e,i).normalize(),l=be.addVectors(i,o.multiplyScalar(s));e.copy(l.sub(this._centerSpacePosition).normalize().multiplyScalar(this._centerSpaceBoneLength).add(this._centerSpacePosition))}})}_getMatrixCenterToWorld(e){return this._center?e.copy(this._center.matrixWorld):e.identity(),e}_getMatrixWorldToCenter(e){return this._center?e.copy(this._center.userData.inverseCacheProxy.inverse):e.identity(),e}_getParentMatrixWorld(){return this.bone.parent?this.bone.parent.matrixWorld:Te}}class ke{constructor(e,n){this.colliderGroups=[],this.springBoneGroupList=[],this.colliderGroups=e,this.springBoneGroupList=n}setCenter(e){this.springBoneGroupList.forEach(n=>{n.forEach(i=>{i.center=e})})}lateUpdate(e){const n=new Set;this.springBoneGroupList.forEach(i=>{i.forEach(a=>{this._updateWorldMatrix(n,a.bone),a.update(e)})})}reset(){const e=new Set;this.springBoneGroupList.forEach(n=>{n.forEach(i=>{this._updateWorldMatrix(e,i.bone),i.reset()})})}_updateWorldMatrix(e,n){e.has(n)||(n.parent&&this._updateWorldMatrix(e,n.parent),n.updateWorldMatrix(!1,!1),e.add(n))}}const Se=new t.Vector3,He=new t.MeshBasicMaterial({visible:!1});class Be{import(e){var n;return O(this,void 0,void 0,function*(){const i=(n=e.parser.json.extensions)===null||n===void 0?void 0:n.VRM;if(!i)return null;const a=i.secondaryAnimation;if(!a)return null;const s=yield this._importColliderMeshGroups(e,a),o=yield this._importSpringBoneGroupList(e,a,s);return new ke(s,o)})}_createSpringBone(e,n={}){return new We(e,n)}_importSpringBoneGroupList(e,n,i){return O(this,void 0,void 0,function*(){const a=n.boneGroups||[],s=[];return yield Promise.all(a.map(o=>O(this,void 0,void 0,function*(){if(o.stiffiness===void 0||o.gravityDir===void 0||o.gravityDir.x===void 0||o.gravityDir.y===void 0||o.gravityDir.z===void 0||o.gravityPower===void 0||o.dragForce===void 0||o.hitRadius===void 0||o.colliderGroups===void 0||o.bones===void 0||o.center===void 0)return;const l=o.stiffiness,c=new t.Vector3(o.gravityDir.x,o.gravityDir.y,-o.gravityDir.z),d=o.gravityPower,u=o.dragForce,f=o.hitRadius,_=[];o.colliderGroups.forEach(A=>{_.push(...i[A].colliders)});const m=[];yield Promise.all(o.bones.map(A=>O(this,void 0,void 0,function*(){const W=yield e.parser.getDependency("node",A),T=o.center!==-1?yield e.parser.getDependency("node",o.center):null;W&&W.traverse(C=>{const I=this._createSpringBone(C,{radius:f,stiffnessForce:l,gravityDir:c,gravityPower:d,dragForce:u,colliders:_,center:T});m.push(I)})}))),s.push(m)}))),s})}_importColliderMeshGroups(e,n){return O(this,void 0,void 0,function*(){const i=n.colliderGroups;if(i===void 0)return[];const a=[];return i.forEach(s=>O(this,void 0,void 0,function*(){if(s.node===void 0||s.colliders===void 0)return;const o=yield e.parser.getDependency("node",s.node),l=[];s.colliders.forEach(d=>{if(d.offset===void 0||d.offset.x===void 0||d.offset.y===void 0||d.offset.z===void 0||d.radius===void 0)return;const u=Se.set(d.offset.x,d.offset.y,-d.offset.z),f=this._createColliderMesh(d.radius,u);o.add(f),l.push(f)});const c={node:s.node,colliders:l};a.push(c)})),a})}_createColliderMesh(e,n){const i=new t.Mesh(new t.SphereBufferGeometry(e,8,4),He);return i.position.copy(n),i.name="vrmColliderSphere",i.geometry.computeBoundingSphere(),i}}new t.Vector2,new t.OrthographicCamera(-1,1,-1,1,-1,1);const Ie=new t.MeshBasicMaterial({color:16777215,side:t.DoubleSide}),De=new t.Mesh(new t.PlaneBufferGeometry(2,2),Ie);new t.Scene().add(De),new t.Vector3,new t.MeshBasicMaterial({color:16711935,wireframe:!0,transparent:!0,depthTest:!1}),new t.Vector3;function Qe(r,e){if(e=e||{},F0(r,e),e.exclude){var n=[r];r.traverse(i=>n.push(i)),n.forEach(i=>{(~e.exclude.indexOf(i.id)||~e.exclude.indexOf(i.name))&&delete e.averagedDirs[i.id]})}return Ce(r,e)}const Ee=new t.Quaternion;new t.Vector3(0,1,0);function F0(r,e){return e=e||r,e.worldPos=e.worldPos||{},e.averagedDirs=e.averagedDirs||{},e.preRotations=e.preRotations||{},W0(r,e.worldPos),b0(r,e.worldPos,e.averagedDirs),e}function Ce(r,e){return(!e||!e.worldPos)&&(e=e||{},F0(r,e)),V0(r,e.worldPos,e.averagedDirs,e.preRotations),e}function b0(r,e,n){var i=new t.Vector3;r.children.forEach(a=>{var s=e[a.id][0];i.add(s)}),i.multiplyScalar(1/r.children.length),n[r.id]=i,r.children.forEach(a=>{b0(a,e,n)})}function V0(r,e,n,i){var a=n[r.id];a&&(r.quaternion.copy(Ee),r.updateMatrixWorld());var s=i[r.id]||i[r.name];s&&r.quaternion.multiply(s),r.updateMatrixWorld(),r.children.forEach(o=>{var l=e[o.id][0].clone();r.worldToLocal(l),o.position.copy(l)}),r.children.forEach(o=>{V0(o,e,n,i)})}new t.Vector3,new t.Vector3,new t.Vector3,new t.Matrix4;function W0(r,e){var n=r.getWorldPosition(new t.Vector3);e[r.id]=[n],r.children.forEach(i=>{W0(i,e)})}class Ne{constructor(){this.head=new t.Object3D,this.leftHand=new t.Object3D,this.leftHand.pointer=0,this.leftHand.grip=0,this.rightHand=new t.Object3D,this.rightHand.pointer=0,this.rightHand.grip=0,this.floorHeight=0}}class Oe{constructor(e){this.vrTransforms=new Ne,this.referencePlayerHeightHmd=1.79,this.referencePlayerWidthWrist=1.39,this.playerHeightHmd=1.79,this.playerWidthWrist=1.39}}class k0{constructor(){this.transform=new t.Object3D,this.upperArm=new t.Object3D,this.lowerArm=new t.Object3D,this.hand=new t.Object3D,this.transform.add(this.upperArm),this.upperArm.add(this.lowerArm),this.lowerArm.add(this.hand)}}const Ue=new t.Vector3,qe=new t.Vector3,g={getWorldPosition(r,e){return e.setFromMatrixPosition(r.matrixWorld)},getWorldQuaternion(r,e){return r.matrixWorld.decompose(Ue,e,qe),e},getWorldScale(r,e){return e.setFromMatrixScale(r.matrixWorld)},updateMatrix(r){r.matrix.compose(r.position,r.quaternion,r.scale)},updateMatrixWorld(r){r.matrixWorld.multiplyMatrices(r.parent.matrixWorld,r.matrix)},updateMatrixMatrixWorld(r){r.matrix.compose(r.position,r.quaternion,r.scale),r.matrixWorld.multiplyMatrices(r.parent.matrixWorld,r.matrix)}},l0=new t.Vector3(1,0,0),t0=new t.Quaternion().setFromAxisAngle(new t.Vector3(0,1,0),Math.PI);new t.Vector3;const h0=new t.Vector3,q=new t.Vector3;new t.Vector3,new t.Vector3;const Z=new t.Quaternion,c0=new t.Quaternion,Y=new t.Quaternion,d0=new t.Euler;new t.Euler;const ze=new t.Quaternion(0,1,0,0);class je{constructor(e,n){this.rig=e,this.shoulder=n,this.poseManager=e.poseManager,this.vrTransforms=this.poseManager.vrTransforms}Update(){this.shoulder.proneFactor=this.getProneFactor(),this.shoulder.prone=this.shoulder.proneFactor>0,this.shoulder.prone?this.shoulder.lastProneTimestamp=Date.now():this.shoulder.lastStandTimestamp=Date.now(),this.updateHips(),this.rotateShoulderBase(),this.updateNeck()}updateHips(){const e=Z.copy(this.vrTransforms.head.quaternion).multiply(t0),n=ze,i=d0.setFromQuaternion(n,"YXZ");i.x=0,i.z=0;const a=c0.setFromEuler(i);if(a.multiply(Y.setFromAxisAngle(l0,this.shoulder.proneFactor*Math.PI/2)),!this.rig.legsManager.leftLeg.standing&&!this.rig.legsManager.rightLeg.standing){const u=1-Math.min(this.rig.legsManager.leftLeg.standFactor,this.rig.legsManager.rightLeg.standFactor);a.multiply(Y.setFromAxisAngle(l0,u*Math.PI/4))}else{const u=Math.min(this.rig.legsManager.leftLeg.standFactor,this.rig.legsManager.rightLeg.standFactor);a.multiply(Y.setFromAxisAngle(l0,(1-u)*Math.PI/4))}const d=h0.copy(this.vrTransforms.head.position).sub(q.copy(this.shoulder.eyes.position).applyQuaternion(e)).sub(q.copy(this.shoulder.head.position).applyQuaternion(e)).sub(q.copy(this.shoulder.neck.position).applyQuaternion(a)).sub(q.copy(this.shoulder.transform.position).applyQuaternion(a)).sub(q.copy(this.shoulder.spine.position).applyQuaternion(a));this.shoulder.hips.position.copy(d),this.shoulder.hips.quaternion.copy(a),g.updateMatrix(this.shoulder.hips),this.shoulder.hips.matrixWorld.copy(this.shoulder.hips.matrix),g.updateMatrixWorld(this.shoulder.spine),g.updateMatrixWorld(this.shoulder.transform)}updateNeck(){const e=Z.copy(this.vrTransforms.head.quaternion).multiply(t0),n=d0.setFromQuaternion(e,"YXZ");n.x=0,n.z=0;const i=c0.setFromEuler(n);this.shoulder.neck.quaternion.copy(i).premultiply(g.getWorldQuaternion(this.shoulder.neck.parent,Y).invert()),g.updateMatrixMatrixWorld(this.shoulder.neck),this.shoulder.head.quaternion.copy(e).premultiply(g.getWorldQuaternion(this.shoulder.head.parent,Y).invert()),g.updateMatrixMatrixWorld(this.shoulder.head),g.updateMatrixWorld(this.shoulder.eyes)}rotateShoulderBase(){const e=this.getCombinedDirectionAngleUp();this.shoulder.transform.quaternion.setFromEuler(d0.set(0,e,0,"YXZ")).premultiply(Z.copy(this.shoulder.hips.quaternion).multiply(t0)),this.shoulder.transform.quaternion.premultiply(g.getWorldQuaternion(this.shoulder.transform.parent,Z).invert()),g.updateMatrixMatrixWorld(this.shoulder.transform),g.updateMatrixWorld(this.shoulder.leftShoulderAnchor),g.updateMatrixWorld(this.shoulder.rightShoulderAnchor)}getCombinedDirectionAngleUp(){const e=Z.copy(this.shoulder.hips.quaternion).multiply(t0),n=c0.copy(e).invert(),i=h0.copy(this.vrTransforms.leftHand.position).sub(this.vrTransforms.head.position).applyQuaternion(n),a=q.copy(this.vrTransforms.rightHand.position).sub(this.vrTransforms.head.position).applyQuaternion(n);i.y=0,a.y=0;const s=i.z>0,o=a.z>0;s&&(i.z*=o?-2:-1),o&&(a.z*=s?-2:-1);const l=h0.addVectors(i.normalize(),a.normalize());return Math.atan2(l.x,l.z)}getProneFactor(){return 1-Math.min(Math.max((this.vrTransforms.head.position.y-this.rig.height*.3)/(this.rig.height*.3),0),1)}}const S0=new t.Vector3,Ge=new t.Vector3(0,0,1),H0=new t.Quaternion().setFromAxisAngle(new t.Vector3(0,1,0),Math.PI/2),B0=new t.Quaternion().setFromAxisAngle(new t.Vector3(0,1,0),-Math.PI/2),Ze=new t.Quaternion().setFromAxisAngle(new t.Vector3(0,0,1),Math.PI/2),Ye=new t.Quaternion().setFromAxisAngle(new t.Vector3(0,0,1),-Math.PI/2),$e=new t.Quaternion().setFromAxisAngle(new t.Vector3(0,1,0),Math.PI);new t.Vector3;const u0=new t.Vector3,$=new t.Vector3,Xe=new t.Vector3,I0=new t.Vector3,p0=new t.Vector3,D0=new t.Vector3,Je=new t.Quaternion,Ke=new t.Quaternion,X=new t.Quaternion,et=new t.Euler,Q0=new t.Matrix4;class E0{constructor(e,n,i,a,s){this.arm=e,this.shoulder=n,this.shoulderPoser=i,this.target=a,this.left=s,this.upperArmLength=0,this.lowerArmLength=0,this.armLength=0}Start(){this.upperArmLength=g.getWorldPosition(this.arm.lowerArm,u0).distanceTo(g.getWorldPosition(this.arm.upperArm,$)),this.lowerArmLength=g.getWorldPosition(this.arm.hand,u0).distanceTo(g.getWorldPosition(this.arm.lowerArm,$)),this.armLength=this.upperArmLength+this.lowerArmLength}Update(){g.updateMatrixWorld(this.arm.transform),g.updateMatrixWorld(this.arm.upperArm);const e=g.getWorldPosition(this.arm.upperArm,u0),n=this.target.quaternion;let i=$.copy(this.target.position);const a=.01;this.target.position.z>this.shoulder.shoulderPoser.vrTransforms.head.position.z&&(this.target.position.z=this.shoulder.shoulderPoser.vrTransforms.head.position.z+a,i=$.copy(this.target.position));const s=.015;this.target.position.z<this.shoulder.shoulderPoser.vrTransforms.head.position.z&&this.target.position.z>this.shoulder.shoulderPoser.vrTransforms.head.position.z-s&&(this.target.position.z=this.shoulder.shoulderPoser.vrTransforms.head.position.z-s,i=$.copy(this.target.position));const o=g.getWorldQuaternion(this.shoulder.transform,Je),l=Ke.copy(o).invert(),c=this.upperArmLength,d=e.distanceTo(i)/2,u=c>d?Math.sqrt(c*c-d*d):0,f=Xe.copy(i).sub(e).normalize().cross(I0.set(-1,0,0).applyQuaternion(o)),_=et.setFromQuaternion(X.multiplyQuaternions(n,l).premultiply($e),"XYZ");if(this.left){const Q=Math.min(Math.max((_.y+Math.PI*.1)/(Math.PI/2),0),1);_.z=Math.min(Math.max(_.z,-Math.PI/2),0),_.z=_.z*(1-Q)+-Math.PI/2*Q}else{const Q=Math.min(Math.max((-_.y-Math.PI*.1)/(Math.PI/2),0),1);_.z=Math.min(Math.max(_.z,0),Math.PI/2),_.z=_.z*(1-Q)+Math.PI/2*Q}f.applyQuaternion(l).applyAxisAngle(Ge,_.z).applyQuaternion(o);const m=I0.copy(e).add(i).divideScalar(2).add(p0.copy(f).multiplyScalar(u)),A=p0.set(this.left?-1:1,0,0).applyQuaternion(o);this.arm.upperArm.quaternion.setFromRotationMatrix(Q0.lookAt(S0,D0.copy(m).sub(e),A)).multiply(this.left?B0:H0).premultiply(g.getWorldQuaternion(this.arm.upperArm.parent,X).invert()),g.updateMatrixMatrixWorld(this.arm.upperArm);const W=.001,T=this.left?W:-W,C=0,I=0;let v=n.w+Math.PI/2.81,R=n.w+Math.PI/2.81,D=0;this.left?D=v<1.2?v+2.2:v:(D=R<1.2?R-4:R,console.log(D)),this.arm.lowerArm.quaternion.setFromRotationMatrix(Q0.lookAt(S0,D0.copy(i).sub(m),p0.set(T,C,I).applyQuaternion(X.setFromAxisAngle(new t.Vector3(n.x,n.y,n.z),D)))).multiply(this.left?B0:H0).premultiply(g.getWorldQuaternion(this.arm.lowerArm.parent,X).invert()),g.updateMatrixMatrixWorld(this.arm.lowerArm),this.arm.hand.quaternion.copy(this.target.quaternion).multiply(this.left?Ye:Ze).premultiply(g.getWorldQuaternion(this.arm.hand.parent,X).invert()),g.updateMatrixMatrixWorld(this.arm.hand)}}class tt{constructor(e){this.transform=new t.Object3D,this.hips=new t.Object3D,this.spine=new t.Object3D,this.neck=new t.Object3D,this.head=new t.Object3D,this.eyes=new t.Object3D,this.hips.add(this.spine),this.spine.add(this.transform),this.transform.add(this.neck),this.neck.add(this.head),this.head.add(this.eyes),this.leftShoulderAnchor=new t.Object3D,this.transform.add(this.leftShoulderAnchor),this.rightShoulderAnchor=new t.Object3D,this.transform.add(this.rightShoulderAnchor),this.leftArm=new k0,this.rightArm=new k0,this.leftShoulderAnchor.add(this.leftArm.transform),this.rightShoulderAnchor.add(this.rightArm.transform),this.prone=!1,this.proneFactor=0;const n=Date.now();this.lastStandTimestamp=n,this.lastProneTimestamp=n,this.shoulderPoser=new je(e,this),this.leftArmIk=new E0(this.leftArm,this,this.shoulderPoser,this.shoulderPoser.vrTransforms.leftHand,!0),this.rightArmIk=new E0(this.rightArm,this,this.shoulderPoser,this.shoulderPoser.vrTransforms.rightHand,!1)}Start(){this.leftArmIk.Start(),this.rightArmIk.Start()}Update(){this.shoulderPoser.Update(),this.leftArmIk.Update(),this.rightArmIk.Update()}}new t.Vector3,new t.Vector3(1,1,1),new t.Quaternion,new t.Quaternion().setFromAxisAngle(new t.Vector3(1,0,0),-Math.PI/2),new t.Quaternion().setFromAxisAngle(new t.Vector3(1,0,0),Math.PI/2),new t.Quaternion().setFromAxisAngle(new t.Vector3(1,0,0),-Math.PI/4);const C0=new t.Vector3;new t.Vector3,new t.Vector3,new t.Vector3,new t.Vector3,new t.Vector3,new t.Vector3,new t.Quaternion,new t.Quaternion,new t.Quaternion,new t.Euler,new t.Matrix4,new t.Matrix4,new t.Matrix4;class N0{constructor(e,n){this.transform=new t.Object3D,this.upperLeg=new t.Object3D,this.lowerLeg=new t.Object3D,this.foot=new t.Object3D,this.foot.stickTransform=new t.Object3D,this.foot.startTransform=new t.Object3D,this.foot.endTransform=new t.Object3D,this.foot.startHmdFloorTransform=new t.Object3D,this.transform.add(this.upperLeg),this.upperLeg.add(this.lowerLeg),this.lowerLeg.add(this.foot),this.upperLegLength=0,this.lowerLegLength=0,this.legLength=0,this.eyesToUpperLegOffset=new t.Vector3,this.legsManager=e,this.left=n,this.standing=!0,this.standFactor=1;const i=Date.now();this.lastStandTimestamp=i,this.lastJumpTimestamp=i,this.stepping=!1,this.lastStepTimestamp=i,this.balance=1}Start(){this.upperLegLength=this.lowerLeg.position.length(),this.lowerLegLength=this.foot.position.length(),this.legLength=this.upperLegLength+this.lowerLegLength,g.getWorldPosition(this.upperLeg,this.eyesToUpperLegOffset).sub(g.getWorldPosition(this.legsManager.rig.shoulderTransforms.eyes,C0))}Update(){const e=C0.copy(this.foot.stickTransform.position);this.foot.quaternion.copy(e),this.lowerLeg.quaternion.copy(e),g.updateMatrixMatrixWorld(this.upperLeg),g.updateMatrixMatrixWorld(this.lowerLeg),g.updateMatrixMatrixWorld(this.foot)}}class rt{constructor(e){this.hips=e.shoulderTransforms.hips,this.leftLeg=new N0(this,!0),this.hips.add(this.leftLeg.transform),this.rightLeg=new N0(this,!1),this.hips.add(this.rightLeg.transform),this.rig=e,this.poseManager=e.poseManager,this.legSeparation=0,this.lastHmdPosition=new t.Vector3,this.hmdVelocity=new t.Vector3}Start(){this.leftLeg.Start(),this.rightLeg.Start()}Update(){this.leftLeg.Update(),this.rightLeg.Update()}}var it=`const numTicks = 1;\r
\r
let tick = 0;\r
let sampleSum = 0;\r
let numSamples = 0;\r
